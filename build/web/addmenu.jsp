<%-- 
    Document   : addmenu
    Created on : 18 Nov, 2020, 4:36:32 PM
    Author     : Adhiksha
--%>
...
<% 
    Integer id=(Integer) request.getAttribute("resid");
    session.setAttribute("resid", id);
%>
<a href="adddish.html" style="text-align: left;" class="btn btn-primary">Add New Dish </a>
<a href="delete.jsp" style="text-align: left;" class="btn btn-primary" >Delete Dish</a>
               <br><Br> 
...
%>
    <tbody>
      <tr>
        ...
        <td><%=itr.next()%></td>
        <td><%=itr.next()%></td>
     <td style="width: 100px;height: 100px;"><p style="width: 100px;height: 100px;"><img style=" width: 100px;height: 100px;" alt="image.jpg" src="data:image/jpeg;base64,<%=itr.next()%> "/></p></td>
      </tr>
      <%}%>
    </tbody>
  </table>
  <a href="adddish.html">Press</a>
