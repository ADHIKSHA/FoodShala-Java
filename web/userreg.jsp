<%-- 
    Document   : userreg
    Created on : 19 Nov, 2020, 10:45:18 PM
    Author     : Adhiksha
--%>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Restraunt Registration</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="user_register" method="POST" class="billing-form">
							<h3 class="mb-4 billing-heading">Your Details</h3>
                ...
                <div class="col-md-6">
	                <div class="form-group">
	                	<label for="emailaddress">Share Your google location link here:-</label>
           ...
           <div class="col-xl-5">
	          <div class="row mt-5 pt-3">
									...
									<p><input class="btn btn-primary py-3 px-4" type="submit" name="register" value="Register Now"></p>
								</div>
	          	</div>
	          </form><!-- END -->
					</div>
